...
Rime：[CustomPinyinDictionary_rime.yaml](https://github.com/cloudskytian/CustomPinyinDictionaryForMSPinyin/releases/latest/download/CustomPinyinDictionary_rime.dict.yaml)
